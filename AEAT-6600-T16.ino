...
const int MAG_HI = 8,
            ...
            PROG = 4,
            NCS = 5;
const int CLOCK_PIN = 6; //The clock pin is also accessed directly as PORTD{7} in the readPosition() function. Changing the code only here will not work.
const int DATA_PIN = 7; //The data pin is also accessed directly as PINE{6} in the readPosition() function. Changing the code only here will not work.
const int BIT_COUNT = 10; // this's the precision of rotary encoder.
